...
<div class="max-w-[740px] mx-auto py-8">
        ...
        <form wire:submit="submitProp" class="p-4 space-y-4">
            ...
            <div>
                ...
                <select wire:model="category_id"
                    class="w-full bg-white border border-gray-200 rounded text-sm p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
