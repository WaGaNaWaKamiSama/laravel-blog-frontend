...
-                    <div class="w-10 bg-gray-50/50 flex flex-col items-center pt-3 gap-1 border-r border-gray-100/50">
                        ...
                        <svg class="w-6 h-6 text-gray-400 hover:text-blue-600" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('posts.show', $post['slug']) }}"
                        ...
                        <div class="flex items-center gap-1.5 text-xs text-gray-500 mb-2">
                            @if(isset($post['category']))
                                <span
                                    class="font-bold text-gray-900 hover:underline z-10 relative">r/{{ $post['category']['name'] }}</span>
                                <span class="text-gray-400">•</span>
                            @endif
                            <span>Posted by <span
                                    class="hover:underline">u/{{ $post['user']['name'] ?? 'Anonim' }}</span></span>
                            <span class="text-gray-400">•</span>
                        ...
                        <div class="mb-3">
                            @if(isset($post['image']))
                                <div
                                    class="max-h-[512px] overflow-hidden rounded-md border border-gray-200 flex justify-center bg-black/5 relative group">
                                    <div class="absolute inset-0 bg-cover bg-center blur-xl opacity-50"
